...
layout: single
toc: true
title: "Satisfaction with Pay Among 19,224 Australian Workers Across 19 Industries"
date: 2025-08-25
categories:
  - Blog
tags:
  ...
  - Well-being
header:
  teaser: /assets/images/37_industry_satisfaction_vs_salary_scatter.png
  og_image: /assets/images/37_industry_satisfaction_vs_salary_scatter.png
output:
  md_document:
    variant: gfm
    preserve_yaml: true
...
In the graph below, each point represents a different industry. The average satisfaction with pay reported in each industry is plotted as a function of the mean salary reported from that industry. The regression line in the plot represents the level of satisfaction that would be expected based on the actual salaries in that industry.

![](/assets/images/37_industry_satisfaction_vs_salary_scatter.png)
