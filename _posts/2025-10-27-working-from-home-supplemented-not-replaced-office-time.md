...
layout: single
toc: true
title: "Working from Home Hasn't Just Replaced Time at the Workplace—It Has Supplemented It"
date: 2025-10-27
categories:
  - Blog
tags:
  ...
  - Work-Life Balance
header:
  teaser: /assets/images/27_15_home_workplace_decomposition.png
  og_image: /assets/images/27_15_home_workplace_decomposition.png
output:
  md_document:
    variant: gfm
    preserve_yaml: true
...
![](/assets/images/27_15_home_workplace_decomposition.png)

So, is working from home driving the increase in our personal workloads? Yes and no.

The data points to two distinct drivers:

1. A steady, pre-COVID trend of increasing hours at the office that pre-dated the increase in working from home.

2. A post-COVID shift to hybrid, where the new hours at home have been added on top of a smaller reduction in office hours, resulting in a longer total work week.
