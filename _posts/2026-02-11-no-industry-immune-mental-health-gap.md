...
layout: single
toc: true
title: "No Industry is Immune to the Mental Health Gap"
date: 2026-02-11
categories:
  - Blog
tags:
  ...
  - Psychosocial Safety
header:
  teaser: /assets/images/21_20_industry_cohort_combined.png
  og_image: /assets/images/21_20_industry_cohort_combined.png
output:
  md_document:
    variant: gfm
    preserve_yaml: true
...
⬅️ Left panel: The expected difference in mental health between someone born in 1960 vs 2005, working in the same industry between 2022 and 2024.

➡️ Right panel: The predicted mental health trend across all birth cohorts for each industry over these years.

![](/assets/images/21_20_industry_cohort_combined.png)
...
Accommodation & Food Services (0.84)
Information Media & Telecommunications (0.79)
Rental, Hiring & Real Estate (0.77)

🔵 Smallest gaps:

Mining (0.23),
Electricity, Gas, Water & Waste (0.23),
Financial & Insurance Services (0.54).
